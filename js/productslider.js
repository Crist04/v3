...
let productList = [
	{
		...
		'priceBy': '2.599,00',
		'installmentPlan': '10',
		'imgURL': 'https://samsungbr.vtexassets.com/arquivos/ids/312084-285-189?v=637369886509730000&width=285&height=189&aspect=true',
		'productURL': '#'
	},
	{
		'sku': 'sku0001',
		...
		'priceBy': '1.187,50',
		'installmentPlan': '10',
		'imgURL': 'https://samsungbr.vtexassets.com/arquivos/ids/312062-285-189?v=637369460623370000&width=285&height=189&aspect=true',
		'productURL': '#'
	},
	{
		'sku': 'sku0002',
	...
	},
	{
		...
		'priceBy': '2.650,50',
		'installmentPlan': '10',
		'imgURL': 'https://samsungbr.vtexassets.com/arquivos/ids/311707-285-189?v=637346555901070000&width=285&height=189&aspect=true',
		'productURL': '#'
	}
]
...
const writeProductCardTemplate = ($target = document.querySelector('body'), productData = productList[0]) => {
	$target.innerHTML += `
	<div class="card shadown" data-sku="${productData.sku}">
		...
		<a class="product-link img" href="${productData.productURL}">
			<div class="holder-product-img">
				<img class="product-img" src="${productData.imgURL}" alt="${productData.name}" loading="lazy" onload="this.classList.add('loaded');">
			</div>
		</a>
		...
		<p class="product-price">
			<span class="of">
				<span class="accessibility-text">${productStaticText.productPriceAccessibilityText[0]}</span>${productStaticText.productPriceMonetaryUnit}${productData.priceOf}
			</span>
			<span class="by">
				<span class="accessibility-text">${productStaticText.productPriceAccessibilityText[1]}</span>${productStaticText.productPriceMonetaryUnit}${productData.priceBy}
			</span>
...
// page that will receive the collection of cards.
...
// My old plugin, I rewrite it removing the jQuery
// This is the new version https://codepen.io/adrianoenache/pen/eYEajGV
